...
<body>
    ...
    <main class="error-page">
        <div class="error-container">
            <div class="error">
                <p class="error-note">Oops! Page not found</p>
                <p class="error-code"><span>4</span><span>0</span><span>4</span></p>
            </div>
            <p class="error-text">we are sorry, but the page you requested was not found</p>
